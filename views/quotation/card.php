		...
		<div class="mg-r-20 mg-b-40 contact-wrap">
			...
			<div>
				<div class="inlineblock vmiddle mg-r-20">
					<select class="nice-sel-wrap" data-target="input-radcheck-card" name="paper" oninvalid="alert('請選擇紙張種類');" required >
				...
				<div class="inlineblock vmiddle sel-others-input">
					<input type="text" class="input-text input-radcheck" id="input-radcheck-card" name="other_paper" placeholder="其他" disabled />
				</div>
			</div>
