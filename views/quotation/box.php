	...
	<div class="clearfix">
		...
		<?php
			$box_type_radio_array = [
				['label' => '普通盒<img src="images/tmp/box1.png">', 'opt' => '普通盒'],
				['label' => '插底盒<img src="images/tmp/box2.png">', 'opt' => '插底盒'],
				['label' => '糊底盒<img src="images/tmp/box3.png">', 'opt' => '糊底盒'],
				['label' => '抽屜盒<img src="images/tmp/box4.png">', 'opt' => '抽屜盒'],
				['label' => '天地盒<img src="images/tmp/box5.png">', 'opt' => '天地盒'],
				['label' => 'PIZZA盒<img src="images/tmp/box6.png">', 'opt' => 'PIZZA盒'],
			];
		...
		<div class="mg-r-20 mg-b-40 contact-wrap">
			...
			<div>
				<div class="inlineblock vmiddle mg-r-20">
					<select class="nice-sel-wrap" data-target="input-radcheck-box" name="paper" oninvalid="alert('請選擇紙張種類');" required >
				...
				<div class="inlineblock vmiddle sel-others-input">
					<input type="text" class="input-text input-radcheck" id="input-radcheck-box" name="other_paper" placeholder="其他" disabled />
				</div>
			</div>
